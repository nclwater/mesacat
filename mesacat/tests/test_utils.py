from mesacat.utils import create_movie, target_occupancy_plot, traffic_plot
...
class TestUtils(TestCase):
    ...
    def test_traffic_plot(self):
        traffic_plot(os.path.join(sample_data, 'test-model'), os.path.join(outputs, 'test-model-traffic.png'))
